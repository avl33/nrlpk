...
- **allwordscount** - число выражений в тексте (не равно общему числу слов в тексте)
...
- **garbagewordscount** - число выражений из текста, попавших в мусор
...
- **garbage-%** - процент мусора (неидентефиципрованных выражений к общему числу выражений) в тексте
